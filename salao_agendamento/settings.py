"""
Django settings for salao_agendamento project.
...
SECRET_KEY = 'django-insecure-31n!ea%0s=cb3(b19tfd@zg_cpuez5l4gc=+#ksy(r_ecv1=q('
...
ROOT_URLCONF = 'salao_agendamento.urls'
...
WSGI_APPLICATION = 'salao_agendamento.wsgi.application'
...
#         'NAME': os.environ.get('DB_NAME', 'salao_agendamento'),
