...
class Comerciante(models.Model):
    """
    Modelo para representar um comerciante (dono do salão)
    """
...
class Funcionario(models.Model):
    """
    Modelo para representar um funcionário do salão
    """
    user = models.OneToOneField(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
...
class Servico(models.Model):
    """
    Modelo para representar um serviço oferecido pelo salão
    """
    comerciante = models.ForeignKey(
        Comerciante,
        on_delete=models.CASCADE,
